...
const MILITARY_RANKS = [
  { tier: 1, min: 0, max: 3, name: "列兵", color: "#4ade80", stripes: 1, stars: 0 },
  { tier: 2, min: 4, max: 9, name: "上等兵", color: "#2dd4bf", stripes: 2, stars: 0 },
  { tier: 3, min: 10, max: 14, name: "下士", color: "#facc15", stripes: 1, stars: 0, bar: true },
  { tier: 4, min: 15, max: 21, name: "中士", color: "#fb923c", stripes: 2, stars: 0, bar: true },
  { tier: 5, min: 22, max: 29, name: "上士", color: "#f97316", stripes: 3, stars: 0, bar: true },
  { tier: 6, min: 30, max: 35, name: "四级军士长", color: "#38bdf8", stripes: 0, stars: 1, chevron: 4 },
  { tier: 7, min: 36, max: 42, name: "三级军士长", color: "#3b82f6", stripes: 0, stars: 1, chevron: 5 },
  { tier: 8, min: 43, max: 50, name: "二级军士长", color: "#0284c7", stripes: 0, stars: 2, chevron: 5 },
  { tier: 9, min: 51, max: 59, name: "一级军士长", color: "#0369a1", stripes: 0, stars: 2, chevron: 6 },
  ...
  { tier: 13, min: 101, max: 120, name: "少校", color: "#14b8a6", stripes: 0, stars: 1, oak: true },
  { tier: 14, min: 121, max: 142, name: "中校", color: "#0d9488", stripes: 0, stars: 2, oak: true },
  { tier: 15, min: 143, max: 163, name: "上校", color: "#0891b2", stripes: 0, stars: 3, oak: true },
  { tier: 16, min: 164, max: 182, name: "大校", color: "#0284c7", stripes: 0, stars: 4, oak: true },
  { tier: 17, min: 183, max: 200, name: "少将", color: "#10b981", stripes: 0, stars: 1, general: true },
  { tier: 18, min: 201, max: 220, name: "中将", color: "#059669", stripes: 0, stars: 2, general: true },
  { tier: 19, min: 221, max: Infinity, name: "上将", color: "#047857", stripes: 0, stars: 3, general: true },
];
